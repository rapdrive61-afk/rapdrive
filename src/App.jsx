    ...
    <div className="rd-admin-shell-v48" style={{display:"flex",position:"fixed",inset:0,background:"#060b10",fontFamily:"'Inter',sans-serif",overflow:"hidden",color:"#f1f5f9"}}>
      <style>{`
        ...
        *::-webkit-scrollbar{width:3px}*::-webkit-scrollbar-thumb{background:#131f30;border-radius:3px}
        ...
        .rd-admin-sidebar-v48{width:132px!important;background:linear-gradient(180deg,#07111f,#040810)!important;border-right:1px solid rgba(96,165,250,.14)!important;box-shadow:18px 0 60px rgba(0,0,0,.32)!important;padding:18px 12px 14px!important;}
        .rd-admin-logo-v48{width:100%!important;align-items:flex-start!important;padding:0 4px 18px!important;margin-bottom:14px!important;border-bottom:1px solid rgba(96,165,250,.10)!important;}
        ...
        .rd-admin-nav-btn-v48{height:48px!important;padding:0 12px!important;border-radius:16px!important;flex-direction:row!important;justify-content:flex-start!important;gap:11px!important;border:1px solid transparent!important;}
        ...
        .rd-admin-nav-btn-v48 span{font-size:12px!important;letter-spacing:.1px!important;color:inherit!important;}
      ...
      {/* SIDEBAR */}
      <aside className="rd-admin-sidebar-v48" style={{width:88,background:"#060b10",borderRight:"1px solid #0d1420",display:"flex",flexDirection:"column",alignItems:"center",padding:"18px 0 14px",flexShrink:0}}>
        {/* Logo */}
        <div className="rd-admin-logo-v48" style={{marginBottom:28,display:"flex",flexDirection:"column",alignItems:"center",gap:6}}>
        ...
        {/* Nav items */}
        <div className="rd-admin-nav-v48" style={{display:"flex",flexDirection:"column",gap:4,width:"100%",padding:"0 10px"}}>
          {navItems.map(item=>(
            <button className="rd-admin-nav-btn-v48" key={item.id} onClick={()=>setNav(item.id)} style={{width:"100%",padding:"10px 0 9px",borderRadius:12,border:"none",cursor:"pointer",background:nav===item.id?"linear-gradient(135deg,#0d1f35,#0a1828)":"transparent",color:nav===item.id?"#60a5fa":"#374151",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",gap:6,transition:"all .2s",position:"relative",boxShadow:nav===item.id?"0 2px 12px rgba(59,130,246,0.12)":"none"}}>
